...
class ExtractMedicine:
    def __init__(self):
        ...
        prompt_content = """
            ...
            <특수 규칙>
            - "속이 쓰리다" 또는 "위가 아프다" 또는 "장염"은 증상에 대해 "파모티딘"을 추천합니다.
            - "열이 난다" 또는 "머리가 아프다"는 증상에 대해 "에스빌"을 추천합니다.
            - "잠이 안온다" 또는 "자기 힘들다" 또는 "불면증"은 증상에 대해 "자멘쏙"을 추천합니다.
            - "두드러기" 또는 "알러지" 또는 "가려움증" 또는 "습진" 또는 "옻이 올라온다"는 "아루진"을 추천합니다.
            - "활력" 또는 "비타민"은 "이뮨 멀티 비타민"을 추천합니다
